...
public class INPluginWrapper : MonoBehaviour
{
    ...
    private AdRequest CreateAdRequest()
    {
        return new AdRequest.Builder()
            ...
            .AddTestDevice("e68e380126525ea9baf09b1512deb52c")
            //.AddKeyword("game")
    ...
    private void RequestBanner()
    {
        if (AdsWrapper.Instance.bannerEnabled)
        {
            ...
            Debug.Log("Banner unit ID = " + AdsWrapper.Instance.unitBanner);
            // Create a 320x50 banner at the top of the screen.
            this.bannerView = new BannerView(AdsWrapper.Instance.unitBanner, AdSize.Banner, AdPosition.Top);
    ...
    private void ShowRewardBasedVideo()
    {
		...
		else
		{
            if (Advertisement.IsReady("rewardedVideo"))
            {
                ...
                {
                    resultCallback = new Action<ShowResult>((r) => {
                        Debug.Log("Advertisement Unity rewarded video");

                        if (r == ShowResult.Finished) {
                            HandleRewardBasedVideoRewarded(this, new Reward());
                        } else {
                            HandleRewardBasedVideoFailedToLoad(this, EventArgs.Empty);
                        }
                    })
                });
            }
    ...
    {
        this.Log("UnityOnBannerFailed " + args.Message);
    }
    ...
    {
        this.Log("UnityOnInterFailed " + args.Message);
    }
...
// Initialize the Google Mobile Ads SDK.
	...
	public bool IsRewardedAvailable()
	{
		...
		return true;
#else
        return this.rewardBasedVideo.IsLoaded() || Advertisement.IsReady("rewardedVideo");
#endif
	}
