...
#if UNITY_ANDROID
	public static void ShareAndroid(string body, string subject, string url, string[] filePaths, string mimeType, bool chooser, string chooserText, string appPackage = null)
	{
		...
		using (AndroidJavaObject intentObject = new AndroidJavaObject("android.content.Intent"))
		{
			...
			if (appPackage != null){
				using (intentObject.Call<AndroidJavaObject>("setPackage", appPackage))
				{
